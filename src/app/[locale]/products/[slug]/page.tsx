...
export default async function ProductDetailPage({
  ...
  const { slug } = await params;
  const [product, siteSettings, t, locale] = await Promise.all([
          ...
          <div className="flex flex-col">
            ...
            {reviewsEnabled && reviewSummary.count > 0 && (
              <div className="mt-2 flex items-center gap-2">
                ...
                <span className="text-sm text-muted">
                  {t("reviewCount", { count: reviewSummary.count })}
                </span>
              </div>
            )}
            ...
            {product.product_option_types.length === 0 && (
              <>
                ...
                <p className="mt-1 text-xs text-muted">{t("taxIncluded")}</p>
              </>
            )}
        ...
        <ProductInfoTabs
          tabs={[
            ...
            ...(reviewsEnabled
              ? [
                  {
                    label: t("reviews", { count: reviewSummary.count }),
